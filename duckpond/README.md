...
You can start writing assets in `duckpond/assets/`. The assets are automatically loaded into the Dagster repository as you define them.
...
Tests are in the `duckpond_tests` directory and you can run tests using `pytest`:

```bash
pytest duckpond_tests
```
